...
export default function ResidentPage({ onCancel, onSubmitSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const residentRes = await fetch("http://https://software-design-g3-bhma-2026.onrender.com/api/residents", {
        method: "POST",
      ...
      const pendingRes = await fetch(
        "http://https://software-design-g3-bhma-2026.onrender.com/api/pending-resident",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
