        ...
        <div className="heatmap-page-container">
            ...
            <div className="heatmap-controls">
                ...
                <div className="control-group">
                    ...
                    >
                        <option value="diagnosis">🔍 Most Common Diagnosis (by Street)</option>
                ...
                {viewMode === 'diagnosis' ? (
                    ...
                    <>
                        ...
                        <div className="legend-item">
                            ...
                            <span>
                                <strong>🔴 High:</strong> Critical conditions requiring urgent attention
                                <br/>
                        ...
                        <div className="legend-item">
                            ...
                            <span>
                                <strong>🟠 Medium:</strong> Moderate conditions requiring monitoring
                                <br/>
                        ...
                        <div className="legend-item">
                            ...
                            <span>
                                <strong>🟡 Low:</strong> Minor conditions, usually self-limiting
                                <br/>
            ...
            <div className="heatmap-info">
                ...
                <ul>
                    <li><strong>🔍 Zoom:</strong> Use mouse scroll wheel or +/- buttons to zoom in/out</li>
                    <li><strong>👆 Pan:</strong> Click and drag the map to move around</li>
                    <li><strong>🔄 Switch Views:</strong> Toggle between Diagnosis and Condition views at the top</li>
                    <li><strong>🎯 Filter:</strong> Use the dropdown menu to show specific conditions or severity levels</li>
                    <li><strong>ℹ️ Details:</strong> Click on any colored marker to see detailed information</li>
                    <li><strong>📍 Marker Size:</strong> Larger markers indicate more cases in that street</li>
                </ul>
            </div>
        </div>
    );
