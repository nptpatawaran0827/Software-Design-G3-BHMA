...
const AnalyticsPage = ({ onLogout }) => {
    ...
    const fetchHealthRecords = async () => {
      try {
        const response = await fetch(
          "https://software-design-g3-bhma-2026.onrender.com/api/health-records",
        );
  ...
  // Zoomed chart options - larger text for better visibility
  ...
  /* ==================== ZOOM HANDLERS ==================== */
  const handleZoomChart = (chartTitle, chartData, chartType) => {
    const ChartComponent =
      chartType === "bar" ? Bar : chartType === "pie" ? Pie : Doughnut;
    const chartOptions =
      chartType === "bar" ? zoomedBarOptions : zoomedPieOptions;
          ...
          <div className="analytics-page-wrapper">
            <div className="filter-toolbar-top d-flex align-items-center justify-content-end p-3 bg-white shadow-sm mb-4 rounded-3 mx-4 mt-3 gap-3">
              <div className="d-flex align-items-center gap-2 border-end pe-3">
                <div className="btn-group shadow-sm">
                  <button
                    className={`btn btn-sm ${filterMode === "all" ? "btn-primary" : "btn-outline-secondary"}`}
                ...
                <div
                  className={`d-flex align-items-center bg-light px-2 py-1 rounded border ms-1 ${filterMode === "all" ? "opacity-50" : ""}`}
                >
            ...
            <div ref={reportRef} className="report-container px-4">
              <div className="report-header-pdf mb-4 text-center">
                <h2 className="report-title-pdf fw-bold">
                  BARANGAY HEALTH ANALYTICS REPORT
                </h2>
                <h5 className="report-subtitle-pdf text-muted text-uppercase">
                  {filterMode} | {formatPeriodLabel()}
                </h5>
              </div>

              <div className="stats-section-pdf mb-4">
                <h3 className="section-heading mb-3 pb-2 border-bottom">
                  KEY STATISTICS
                </h3>
                  ...
                  <div className="col-4">
                    <div className="stat-card-modern shadow-none border h-100 p-3">
                      ...
                      <div className="stat-content">
                        ...
                        <p className="stat-label text-muted small mb-0">
                          Total Residents
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="col-4">
                    <div className="stat-card-modern shadow-none border h-100 p-3">
                      <div className="stat-content w-100">
                        ...
                        <p className="stat-label text-muted small mb-2">
                          Gender Split
                        </p>
                        <div
              ...
              <div className="charts-section mt-4">
                ...
                <div className="charts-grid">
                  <div
                    className="chart-card-modern border shadow-none"
                    onClick={() =>
                      handleZoomChart(
